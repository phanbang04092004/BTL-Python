class Player:
    ...
    def setMiscStats(self, performance_arr, aerial_duels_arr):
        self.Miscellaneous_Stats["Performance"]["Fls"] = performance_arr[0]
        self.Miscellaneous_Stats["Performance"]["Fld"] = performance_arr[1]
        self.Miscellaneous_Stats["Performance"]["Off"] = performance_arr[2]
        self.Miscellaneous_Stats["Performance"]["Crs"] = performance_arr[3]
        self.Miscellaneous_Stats["Performance"]["OG"] = performance_arr[4]
        self.Miscellaneous_Stats["Performance"]["Recov"] = performance_arr[5]

        self.Miscellaneous_Stats["Aerial Duels"]["Won"] = aerial_duels_arr[0]
        self.Miscellaneous_Stats["Aerial Duels"]["Lost"] = aerial_duels_arr[1]
        self.Miscellaneous_Stats["Aerial Duels"]["Won%"] = aerial_duels_arr[2]
